...
{
    const string privateCode = "dD1zVnyOhUmrPoAoGnYAzQ4Le8IoGbF0GQP69xSpGZPQ";  //Key to Upload New Info
    const string publicCode = "6619b79c8f40bb79a86c4cb5";   //Key to download
    const string webURL = "https//dreamlo.com/lb/";
    //http://dreamlo.com/lb/dD1zVnyOhUmrPoAoGnYAzQ4Le8IoGbF0GQP69xSpGZPQ private link to leaderboard
